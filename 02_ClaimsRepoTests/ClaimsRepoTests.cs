...
namespace _02_ClaimsRepoTests
{
    ...
    public class ClaimsRepoTests
    {
        ...
        public void SeedClaims()
        {
            ...
            _home = new Claim(2, ClaimType.Home, "House fire in kitchen", 4000.00, new DateTime(2018, 04, 11), new DateTime(2018, 04, 12));
            _repo.AddClaim(car);
        ...
        public void AddTest()
        {
            Claim newClaim = new Claim(4, ClaimType.Theft, "Stolen shoes", 4.00, new DateTime(2021, 01, 15), new DateTime(2021, 02, 02));
